...
public class PenghitungJumlahHari extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(CBBulan, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(fieldTahun, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(16, 16, 16))
        );
        ...
        labelOutput.setText("Output Jumlah Hari");
    ...
    private void butHitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butHitungActionPerformed
        try {
            ...
            HitungHari hitung = new HitungHari(tahun, bulan);
            labelOutput.setText(hitung.toString());
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, 
                "Mohon masukkan tahun dengan angka yang valid!", 
    ...
    private void butSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butSimpanActionPerformed
        if (labelOutput.getText().trim().isEmpty() || labelOutput.getText().equals(" ")) {
            JOptionPane.showMessageDialog(this, 
                "Tidak ada hasil yang bisa disimpan. Silakan hitung terlebih dahulu.", 
        ...
        if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            try (PrintWriter writer = new PrintWriter(fileChooser.getSelectedFile())) {
                writer.println(labelOutput.getText());
                JOptionPane.showMessageDialog(this, 
